...
function render() {
    ...
    sideCam.position.x -=1 ; // Adjust the position of sideCam to be in front
    sideCam.lookAt( cameraControls.target );
    renderer.setViewport( 0.5*canvasWidth, 0, 0.5*canvasWidth, 0.5*canvasHeight ); // Render sideCam in the frontCam's previous position
    ...
    renderer.setViewport( 0, 0.5*canvasHeight, 0.5*canvasWidth, 0.5*canvasHeight ); // Render frontCam in the sideCam's previous position
